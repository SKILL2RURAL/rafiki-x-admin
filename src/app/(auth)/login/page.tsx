...
const LoginPage = () => {
  return <div className="relative bg-gradient">
    <Image src={AshBackground} alt="background image" className="h-screen w-screen z-[-1] top-0 left-0 opacity-50"/>
    <div className="absolute top-0 left-0 z-[50] h-screen w-screen flex flex-col items-center justify-center lg:grid grid-cols-2 gap-5">
      <div className="flex justify-center items-center px-10">
        <Image src={logo} alt="Rafiki X" className="w-[100px] h-[100px] lg:w-[500px] lg:h-[500px]"/>
      </div>
