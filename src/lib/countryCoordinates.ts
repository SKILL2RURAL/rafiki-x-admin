export const countryCoordinates: { [key: string]: [number, number] } = {
  ...
  Congo: [15.8277, -0.228],
  "Congo (Democratic Republic)": [21.7587, -4.0383],
  ...
  Mauritius: [57.5522, -20.348],
  Mexico: [-102.5528, 23.6345],
  Micronesia: [158.2151, 7.4256],
  ...
  "Papua New Guinea": [143.9555, -6.315],
  ...
  "Saint Kitts and Nevis": [-62.7829, 17.357],
